...
\item EJ\+\_\+\+XXX\+\_\+\+Managerクラスによって実世界のオブジェクトとソフトウェア内のインスタンスをstrictに紐づけ、管理可能
...
\DoxyCodeLine{\mbox{\hyperlink{main_8cpp_a644fcbd84e8709ecffe4f8ceb8db4dab}{motor}} = \mbox{\hyperlink{classEJ__DCMotor__Manager_a0347df3c51144cf13e702ca025740413}{EJ\_DCMotor\_Manager::createMotor}}(13, 14, 0); \textcolor{comment}{/* ピン1, ピン2, インスタンス識別id */}}
\DoxyCodeLine{\mbox{\hyperlink{main_8cpp_a8dc3f522415638cc2f4b9a5ae4333a8c}{motorAlias}} = \mbox{\hyperlink{classEJ__DCMotor__Manager_afc721dde48d0e9f0d692ef3d3da85e50}{EJ\_DCMotor\_Manager::getMotor}}(0);}
...
platformio.\+ini のbuild\+\_\+flagに\+M5\+\_\+\+DEBUGを定義することで M5系列の開発ボードでエラーログを出力可能です。
